          ...
          <div class="relative m-auto px-4 py-16 sm:px-6 sm:py-16 lg:py-26 lg:px-8">
            ...
            <div class="mt-10 max-w-sm mx-auto lg:max-w-none lg:flex lg:justify-center">
              <div class="space-y-4 lg:space-y-0 lg:mx-auto lg:inline-grid lg:grid-cols-2 lg:gap-5">
                <a href="https://www.hvhardenberg.nl/lidmaatschap/" target="_blank" class="flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-grey-500 bg-white hover:bg-indigo-50 sm:px-8 border-slate-200 border-1"> Meld je aan </a>
                <a href="/thema" class="flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-[#5b9e8c] hover:bg-opacity-70 sm:px-8"> Bekijk thema's </a>
              </div>
            </div>
          </div>
        </div>
